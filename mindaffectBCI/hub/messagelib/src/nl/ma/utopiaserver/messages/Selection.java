 ...
 */
public class Selection implements UtopiaMessage {
    public static final int MSGID         =(int)'S';
    public static final String MSGNAME    ="SELECTION";
    /**
    ...
    public int objID;
    public Selection(final int timeStamp, final int objID){
     ...
     */ 
    public static Selection deserialize(final ByteBuffer buffer, int version)
        throws ClientException {
        buffer.order(UTOPIABYTEORDER);
        // get the timestamp
        final int timeStamp = buffer.getInt();
        final int objID     = (int)buffer.get();
        return new Selection(timeStamp,objID);
    }
    public static Selection deserialize(final ByteBuffer buffer)
        throws ClientException {
